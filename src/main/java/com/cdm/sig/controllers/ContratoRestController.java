...
public class ContratoRestController {
    ...
    private final ContratoServiceAPI serviceAPI;

    @Autowired
    public ContratoRestController(ContratoServiceAPI serviceAPI) {
    ...
    @PostMapping("/save")
    @PreAuthorize("hasRole('USER') or hasRole('MODERATOR') or hasRole('ADMIN')")
    public ResponseEntity<?> save(@Valid @RequestBody Contrato entity, BindingResult result) {
        if (result.hasErrors()) {
    ...
    public ResponseEntity<?> delete(@PathVariable Long id) {
        Contrato entity = serviceAPI.get(id);
        if (entity != null) {
